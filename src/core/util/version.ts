// Fork from https://github.com/microsoft/vscode/blob/b81bd1a1d191eb2b0d50575153caed703ddd96a3/extensions/git/src/util.ts#L497
...
export function satisfies(v: string | Version, requirement: `${'=' | '>' | '>=' | '<' | '<='} ${string}`): boolean {
